...
yazi_font =pygame.font.SysFont('arialblack' , 60) # parantez içindeki lk kısım yazı tipi ikinci kısım yazı büyüklüğüdür
...
play_img = pygame.image.load("bosbuton.png").convert_alpha()
...
#butonu tanımlarken :
#button_surface = pygame.image.load("bosbuton.png")
...
play_button = Button(play_img, 500, 400, "BAŞLAT")
